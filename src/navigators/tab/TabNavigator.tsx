...
import { BookingScreen, ProfileScreen } from '../../screens'
  ...
  return (
    <Tab.Navigator screenOptions={{ headerShown: false}}>
      <Tab.Screen
        ...
        options={{
          tabBarLabel: ({ focused }) => (
            <Text style={[styles.label, focused ? styles.focusedLabel : styles.unfocusedLabel]}>Home</Text>
          ),
          tabBarIcon: ({ focused }) => (
            <Image
      ...
      <Tab.Screen
        ...
        options={{
          tabBarLabel: ({ focused }) => (
            <Text style={[styles.label, focused ? styles.focusedLabel : styles.unfocusedLabel]}>Booking</Text>
          ),
          tabBarIcon: ({ focused }) => (
            <Image
      ...
      <Tab.Screen
        ...
        options={{
          tabBarLabel: ({ focused }) => (
            <Text style={[styles.label, focused ? styles.focusedLabel : styles.unfocusedLabel]}>Profile</Text>
          ),
          tabBarIcon: ({ focused }) => (
            <Image
