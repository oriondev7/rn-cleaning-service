...
// If you remove the view that uses this style and use only the second one the background and the button layout will get cut. So you need to use this extra style for the extra container.
  subContainer: {
    height: '50%',
    width: '100%',
    marginTop: -SPACING.space_70,
